...
static uint8_t DFU_Leave(USBD_HandleTypeDef *pdev);
...
__ALIGN_BEGIN static uint8_t USBD_DFU_CfgDesc[USB_DFU_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x00,
#ifndef ARDUINO_BL_CDC_INTERFACE
...
#error "ERROR: usbd_dfu_core.c: Modify the file to support more descriptors!"
  ...
  /* 9*/
...
#if ARDUINO_BL_CDC_INTERFACE > 0
    //==========================================================================
    // Interface Association for CDC VCP
    0x08,   // bLength: 8 bytes
    0x0b,   // bDescriptorType: IAD
    0x01,   // bFirstInterface: first interface for this association -- to be filled in
    ...
    0x01,   // bInterfaceNumber: Number of Interface -- to be filled in
    ...
    0x02,   // bDataInterface -- to be filled in
    ...
    0x01,   // bMasterInterface: Communication class interface -- to be filled in
    0x02,   // bSlaveInterface0: Data Class Interface -- to be filled in
    ...
    USB_DESC_TYPE_INTERFACE, // bDescriptorType: interface
    0x02,   // bInterfaceNumber: Number of Interface -- to be filled in
    0x00,   // bAlternateSetting: Alternate setting
...
static uint8_t *USBD_DFU_GetUsrStringDesc(USBD_HandleTypeDef *pdev, uint8_t index, uint16_t *length)
{
  ...
  {
    USBD_GetString((uint8_t *)((USBD_DFU_MediaTypeDef *)pdev->pUserData)->pStrDesc[index - USBD_IDX_INTERFACE_STR -1], USBD_StrDesc, length);
    return USBD_StrDesc;
  }
...
static void reboot(USBD_HandleTypeDef *pdev)
{
...
static uint8_t DFU_Leave(USBD_HandleTypeDef *pdev)
{
  ...
  else
  {
    ...
    restart_timer.attach(callback(reboot, pdev), 0.2f);
